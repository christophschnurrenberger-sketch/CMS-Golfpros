...
<div class="hinweis hinweis--still mt-5">
  <?= Icon::svg('euro', 17) ?>
  <div class="hinweis__text">Deine Rechnungen von <?= Marke::NAME ?> und die Rechnungsanschrift stehen unter
    <a href="<?= Util::attr(App::url('/app/konto.php')) ?>">Konto &amp; Abrechnung</a>.</div>
</div>

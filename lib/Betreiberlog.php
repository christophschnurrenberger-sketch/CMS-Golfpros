...
final class Betreiberlog
{
    ...
    public const AKTIONEN = [
        ...
        'INVOICE_CREATED'         => ['Rechnungsentwurf angelegt', 'INFO'],
        'INVOICE_UPDATED'         => ['Rechnung geändert', 'INFO'],
        'INVOICE_DELETED'         => ['Rechnungsentwurf gelöscht', 'INFO'],
        'INVOICE_ISSUED'          => ['Rechnung ausgestellt', 'INFO'],
        'INVOICE_SENT'            => ['Rechnung versendet', 'INFO'],
        'INVOICE_PAID'            => ['Zahlung vermerkt', 'INFO'],
        'INVOICE_CANCELLED'       => ['Rechnung storniert', 'WARNING'],
        'BILLING_DATA_CHANGED'    => ['Rechnungsanschrift geändert', 'INFO'],
